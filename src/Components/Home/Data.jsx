...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <p className="home__description">I'm an asipiring fullstack developer based in Charlotte, NC. I am currently an apprentice in a 6 month program where I learn the fundamentals of front-end and back-end development programs to jump start my career in tech. I am eager to expand my knowledge to learn the necessary skills to reach my goals and take on challenges. In my freetime, I enjoy working with cars, fitness, and hiking.
        </p>
